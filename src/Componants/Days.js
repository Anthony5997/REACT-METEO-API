...
function Days(props) {
    ...
    return (
        <div>
            <div>
                {numberDay === "" &&
                <CardDay weather={props.state.day1} city={props.state.newCity} lon={props.state.lon} lat={props.state.lat}/>}
                {numberDay === 1 &&
                <CardDay weather={props.state.day1} city={props.state.newCity} lon={props.state.lon} lat={props.state.lat}/>}
                {numberDay === 2 &&
                <CardDay weather={props.state.day2} city={props.state.newCity} lon={props.state.lon} lat={props.state.lat}/>}
                {numberDay === 3 &&
                <CardDay weather={props.state.day3} city={props.state.newCity} lon={props.state.lon} lat={props.state.lat}/>}
                {numberDay === 4 &&
                <CardDay weather={props.state.day4} city={props.state.newCity} lon={props.state.lon} lat={props.state.lat}/>}
                {numberDay === 5 &&
                <CardDay weather={props.state.day5} city={props.state.newCity} lon={props.state.lon} lat={props.state.lat}/>}
